            ...
            child: Align(
              alignment: Alignment.bottomCenter,
                ...
                child: SingleChildScrollView(
                    ...
                    children: [
                      SizedBox(height: McGyver.rsDoubleH(context, 36),),
                      Container(
                        decoration: BoxDecoration(
                     color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Log into your account', style: GoogleFonts.inter(
              fontSize: McGyver.textSize(context, 4.5), fontWeight: FontWeight.w800
            ),),
          ),
          Padding(
            padding: EdgeInsets.only(
            ...
            child: TextFormField(
                ...
                decoration: InputDecoration(
                  prefixIcon: Image.asset('assets/images/email.png', scale: 25,),
          ...
          Padding(
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                  prefixIcon: Image.asset('assets/images/password.png', scale: 25,),
              ...
              _button(),
              SizedBox(
                height: McGyver.rsDoubleH(context, 2.0),
              ),
              GestureDetector(
                onTap: () {
                      Navigator.pushNamed(
                  ...
                  children: [
                    Text('Don’t have an account?', style: GoogleFonts.inter(color: Color(0xffc4c4c4), fontSize: McGyver.textSize(context, 2.3))),
            Text(' Sign Up', style: GoogleFonts.inter(color: Color(0xffFFBE0B), fontSize: McGyver.textSize(context, 2.3)) 
                      ),
