...
class SingleListWork extends StatefulWidget {
  @override
  _SingleListWorkState createState() => _SingleListWorkState();
}

class _SingleListWorkState extends State<SingleListWork> {
  @override
      ...
      color: Colors.blue), 
            ...
            title: Row(
              children: [
                ...
                Text(' Work' , style: GoogleFonts.inter(fontSize: McGyver.textSize(context, 2.3),
