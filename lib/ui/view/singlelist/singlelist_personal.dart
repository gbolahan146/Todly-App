...
class SingleListPers extends StatefulWidget {
  @override
  _SingleListPersState createState() => _SingleListPersState();
}

class _SingleListPersState extends State<SingleListPers> {
  @override
